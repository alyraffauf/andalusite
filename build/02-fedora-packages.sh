...
# we're rebased directly on quay.io/fedora-ostree-desktops/cosmic-atomic.
...
# Prevent partial qt6 upgrades that can break COSMIC between Fedora bumps.
dnf5 versionlock add "qt6-*"

# Ship Flathub for first-boot flatpak preinstall (andalusite's flatpak-nuke-fedora
