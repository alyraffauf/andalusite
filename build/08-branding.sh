...
# OS Release Branding
###############################################################################
# Complete branding changes to make system identify as "Andalusite"
# Following Aurora/Bluefin pattern - maintains full Fedora compatibility

IMAGE_PRETTY_NAME="Andalusite"
IMAGE_LIKE="fedora"
IMAGE_VENDOR="alyraffauf"
IMAGE_NAME="${IMAGE_NAME:-andalusite}"
IMAGE_FLAVOR="${IMAGE_FLAVOR:-main}"
IMAGE_TAG="${UBLUE_IMAGE_TAG:-stable}"
BASE_IMAGE_NAME="${BASE_IMAGE_NAME:-cosmic-atomic}"
FEDORA_VERSION="44"
VERSION="${VERSION:-44}"
HOME_URL="https://github.com/${IMAGE_VENDOR}/andalusite"
DOCUMENTATION_URL="https://github.com/${IMAGE_VENDOR}/andalusite/blob/main/README.md"
SUPPORT_URL="https://github.com/${IMAGE_VENDOR}/andalusite/issues/"
BUG_SUPPORT_URL="https://github.com/${IMAGE_VENDOR}/andalusite/issues/"
CODE_NAME="Silicate"
