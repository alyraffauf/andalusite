export image_name := env("IMAGE_NAME", "andalusite")
...
export qemu_image := env("QEMU_IMAGE", "docker.io/qemux/qemu:latest@sha256:f5b5d39f357e06e44a8d2285a22570e4830b4a44be12e20003d151e1b1a002a1")
...
# Examples:
#   just build                          # builds andalusite:stable (main variant)

# just build andalusite stable dx       # builds andalusite-dx:stable
...
# Examples:
#   just build-qcow2                                    # builds andalusite (main)

# just build-qcow2 localhost/andalusite stable dx       # builds andalusite-dx
